require([
    'dialog',
    'dialogmin',
    'text!' + window.contextRoot + '/apworkbench/js/appAuth/index.html',
    'css!' + window.contextRoot + '/apworkbench/js/appAuth/index.css',
    'css!' + window.contextRoot + '/apworkbench/js/appAuth/modal.css',
    'css!' + window.contextRoot + '/apworkbench/js/appAuth/table.css',
    'css!' + window.contextRoot + '/apworkbench/js/appAuth/paginate.css'
], function () {
    var appListByRoleId = window.contextRoot + "/role-mgr/appListByRoleId";
    var html = require('text!' + window.contextRoot + '/apworkbench/js/appAuth/index.html');
    ...
    document.getElementById('appAuth').innerHTML = html;
    ...
    var viewModel = {
        ...
        pageInit: function () {
            ...
            if(getUrlParam('keyword')){
                $("input[name='searchRole']").val(getUrlParam('keyword'));
            }
            if (getUrlParam("pn")) {
                viewModel.loadRoleList({pn: getUrlParam("pn") || 1,keyword:getUrlParam('keyword')||""});
            } else {
                // 初次加载数据
...
//            viewModel.createAjaxFun(obj, successCallback);
        ...
        clickHandle: {
            ...
            conUser: function (row, event) {  //分配用户
                ...
                window.location.href = "#manage/auth_after_rolemgr?keyword="+keyword+"&roleId=" + r_id + "&pn=" + pn;
            },
