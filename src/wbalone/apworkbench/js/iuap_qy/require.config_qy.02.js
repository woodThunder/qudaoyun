...
require.config({
    paths: {
        ...
        "ocm-wangEditor": ocm_web + "/vendor/wangeditor/wangEditor.min",
        ...
        //中台售后补件 begin ------------------------------------
        "pbill_global": pbill + "/config/global",
        ...
        "pbill_refinfo": pbill + "/components/refinfo/refinfo",
        /* ++++图片轮播 */
        "pbill_jqimgslider": pbill + "/vendor/jquery-image-slider/js/jquery.slider",
        /* 垫片 */
        "pbill_polyfill": pbill + "/vendor/polyfill",
        /* echarts */
        "pbill_echarts": pbill + "/vendor/echarts.min",
    ...
    shim: {
        ...
        "pbill_jqimgslider": {
            deps: [
                "css!" + pbill + "/vendor/jquery-image-slider/css/ie.css",
                "css!" + pbill + "/vendor/jquery-image-slider/css/jquery.slider.css",
                "css!" + pbill + "/vendor/jquery-image-slider/css/print.css"
            ],
            exports: 'pbill_jqimgslider'
        }
        //中台，售后补件end----------------------------------
    }
});
