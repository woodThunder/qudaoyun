...
/***/ function(module, exports, __webpack_require__) {
	...
	window.headerInit = function (dom, title, hideback, backFn, otherBtn) {
		...
		//init the i18n
		// initI18n("/");
		// var back =$.i18n.prop('ht.app.app.0022');
		// back = back ==="ht.app.app.0022"?"返回":back;
		// var backstr = '<button class="u-button backbutton" id="papHeader"><i class="uf uf-arrow-left"></i> '+back+'<span class="u-button-container"><span class="u-ripple"></span></span></button>';
