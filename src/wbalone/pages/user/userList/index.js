...
//                    console.log(viewM.proSearch.searchData());
        ...
        addsave: function () {
            ...
            addsaveData._class = "com.yonyou.uap.wb.entity.management.WBUser";
        ...
        editsave: function () {
            ...
            editsaveData._class = "com.yonyou.uap.wb.entity.management.WBUser";
...
//                );
        ...
        pageInit: function () {
            ...
            viewModel.roleRefDT.on('roledata.valueChange', function (ele) {

                // debugger;
                var roleRefer = $("#refContainerroledata").data('uui.refer');
                var appdata = roleRefer.values;

                roleRefer.uncheckAll();

                if (appdata.length) {
                   var ids =   ko.utils.arrayMap(appdata,function (app) {
        ...
        refInit:function (refCode) {
            ...
            $.ajax({
                ...
                success: function (pRefmodel) {
                    ...
                    app.createComp(document.getElementById('orgRef'), viewModel);
                }
            });
            $.ajax({
                type: "get",
