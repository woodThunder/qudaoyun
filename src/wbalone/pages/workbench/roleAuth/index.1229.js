...
//     });
    ...
    var viewModel = {
        ...
        refInit: function (refCode) {
            ...
            if (!refCode) return alert($.i18n.prop('js.wor.rol.0001', '缺少参数~~'));
            $.ajax({
                type: "get",
                url: '/uitemplate_web/iref_ctr/refInfo/',
                data: {
        ...
        loadRoleList: function (params) {
            ...
            var successCallback = function (res) {
                if (res.status === 1) {
                    ...
                    alert(res.msg ? res.msg : $.i18n.prop('js.wor.rol.0002', '返回错误，请刷新页面'))
                }
            };
...
//                debugger;
                if (res.status === "1") {
                    ...
                    alert(res.msg ? res.msg : $.i18n.prop('js.wor.rol.0003', '返回错误'))
                }
            };
                ...
                $.ajax({
                    ...
                    error: function (e) {
                        if (e.status == 500 && e.responseText == 'Internal Server Error') {
                            $('#emptyImage').show();
                            $('#emptyImage span').html($.i18n.prop('js.wor.rol.0004', '服务连接错误'));
        ...
        clickHandle: {
            ...
            ConObjBusis: function () {//当前角色选择的对象分配实体内容
                ...
                if (curobj) {
                    ...
                    alert($.i18n.prop('js.wor.rol.0005', '请先为当前角色分配对象~~'));
                }
            },
...
//                debugger;
        ...
        CurRole: {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status == "1") {
                            ...
                            alert(res.msg || $.i18n.prop('js.wor.rol.0006', '异常错误'));
                        }
                    }
                });
            ...
            loadConObjData: function (params) {
                ...
                var obj = {
                    type: "get",
                    url: 'security/findAllProfileRegByRoleId.do',
                    data: options
                };
                var successCallback = function (res) {
                    if (res.status === "1") {
