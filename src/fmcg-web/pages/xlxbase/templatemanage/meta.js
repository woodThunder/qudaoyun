define(['fmcg_global'], function () {
    ...
    window.TemplateAllotMeta = {
      meta: {
        ...
        terminalType: {
          type: 'string',
          "refmodel": JSON.stringify(refinfo['terminaltype']),
          "refcfg": '{"ctx":"/uitemplate_web","isMultiSelectedEnabled":true}'
        }, //终端类型
        terminalGrade: {
          type: 'string',
          "refmodel": JSON.stringify(refinfo['terminalgrade']),
          "refcfg": '{"ctx":"/uitemplate_web","isMultiSelectedEnabled":true}'
        }, //终端等级
        userId: {
          type: 'string',
        ...
        actScheme: {
          type: 'string',
          "refmodel": JSON.stringify(refinfo['applytypesref']),
          "refcfg": '{"ctx":"/uitemplate_web","refCode":"","isMultiSelectedEnabled":true}',
        },//活动方案类型
        inspectType: {  //巡查单类型
          type: 'string',
          "refmodel": JSON.stringify(refinfo['sumpotroltypesref']),
          "refcfg": '{"ctx":"/uitemplate_web","refCode":"","isMultiSelectedEnabled":true}',
        },
        //客户类型
        customerChannelType: {
