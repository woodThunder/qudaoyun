define(['text!./channelonhand.html', 'ocm_common', 'ocm_baseview', './meta.js'], function(tpl, common, baseview, model) {
  'use strict'
  var viewModel, app;
  var view = baseview.extend({
    ...
    model: model,
    baseData: {
      baseurl: '/stock/onhand-dims/find-channelOnhandNum',
