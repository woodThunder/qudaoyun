define(['text!./onhandview.html', 'ocm_common', 'ocm_baseview', './meta.js'], function(tpl, common, baseview, model) {
  'use strict'
  var viewModel, app;
  var view = baseview.extend({
    ...
    model: model,
    baseData: {
      baseurl: '/stock/onhand-dims/find-onhandNum',
    ...
    events: {
      ...
      goodsOptDetailsFun: function(obj) {
         ...
         */
        var data = viewModel.simpleList.getSimpleData()[obj];
        var id = data.goodsId;
        var goodsSelection = data.goodsSelection ? data.goodsSelection : "";
        common.goodsOptional.OptionalDetails(viewModel, '商品选配', id, goodsSelection, 'dialog_goodsOptDetails', viewModel.simpleList, viewModel.simpleList);
      ...
      search: function(reindex) {
        ...
        if (Object.getOwnPropertyNames(queryData).length < 1) {
        ...
        $._ajax({
          ...
          success: function(data) {
            ...
            //冻结量
            viewModel.frozennum(viewModel.getSum(data, "frozennum"));
          }
        })
      },
      // 求和
