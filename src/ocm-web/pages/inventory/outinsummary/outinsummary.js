define(['text!./outinsummary.html', 'ocm_common', 'ocm_baseview', './meta.js'], function (tpl, common, baseview, model) {
    'use strict'
    var viewModel, app;
    var view = baseview.extend({
      ...
      events: {
        ...
        exportHandle: function () {
          ...
          var templateUrl = "/stock/out-in-summary-excel" + '/downloadExcelTemplate'; //导出模板地址参数
          var excelDataUrl = "/stock/out-in-summary-excel" + '/excelDataExport'; //导出数据地址参数
