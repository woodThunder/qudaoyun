define(['ocm_simpleview', './meta.js', 'ocm_common', "text!./orderWarehouseStrategy.html"], function (simpleview, model, common, tpl) {
  var viewModel;
  var view = simpleview.extend({
    ...
    baseData: {
      ...
      simpleList: new u.DataTable(model.options.metas.orderWarehouseStrategymeta),
    ...
    rendertype: u.extend({}, common.rendertype, {
      ...
      //分仓策略
      branchMethodRender: function (obj) {
        var stateValue = viewModel.simpleList.getRow(obj.rowIndex).getValue("branchMethod");
        var stateName;
        stateValue == 1 ? (stateName = "单仓") : (stateName = "单仓");
        obj.element.innerHTML = stateName;
      },
    }),
