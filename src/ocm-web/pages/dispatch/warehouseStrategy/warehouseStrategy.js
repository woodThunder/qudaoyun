define(['ocm_simpleview', './meta.js', 'ocm_common', "text!./warehouseStrategy.html"], function (simpleview, model, common, tpl) {
  var viewModel;
  var view = simpleview.extend({
    ...
    baseData: {
      ...
      simpleList: new u.DataTable(model.options.metas.warehouseStrategymeta),
    ...
    rendertype: u.extend({}, common.rendertype, {
      ...
      branchMethodRender: function (obj) {
        ...
        var stateName;
        stateValue == 1 ? (stateName = "单仓") : (stateName = "分仓");
        obj.element.innerHTML = stateName;
      },
    }),
