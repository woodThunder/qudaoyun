define([
    ...
    common, baseview, model, searchbox) {
        ...
        var view = baseview.extend({
            ...
            model: model,
            baseData: {
                baseurl: '/base/supplier-categorys',
                statusField: 'isEnable',
                dialogWidth: '900px',
                simpleList: new u.DataTable(model.options.metas.suppliercategorymeta),
                ...
                treeSetting: {
                    ...
                    callback: {
                        beforeClick: function (treeId, treeData) {
                            var refComp = $("#refContainersuppliercategoryKey").data("uui.refer");
                            if(refComp && treeData) {
