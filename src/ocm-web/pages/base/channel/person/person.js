define(["text!./person.html", "./meta.js", "ocm_common",
    ...
    var view = baseview.extend({
        ...
        baseData: {
            ...
            dialog2cardSource: model.options.dialogs.dialog2,
        ...
        rendertype: u.extend(common.rendertype, {
            beforeEditCheck: function (obj) {
                viewModel.postList.setMeta("postId", "refparam",
                    "{\"EQ_isEnable\":\"1\",\"EQ_organization.id\": null}");
        ...
        afterCreate: function () {
            ...
            //   obj.rowObj.parent.meta.departmentId.refparam = "{\"EQ_isEnable\":\"1\",\"EQ_organization.id\":\"" +
            // organizationId + "\"}"; obj.rowObj.parent.meta.postId.refparam =
