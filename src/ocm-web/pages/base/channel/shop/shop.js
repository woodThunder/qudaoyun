...
personPosturl:"/base/person-posts",
      ...
      isRent: [{ value: "1", name: "是" }, { value: "0", name: "否" }],
      contactdata: [],
      shopdecoareadata: [],
    ...
    events: {
      ...
      beforeEdit: function (index, rowId) {
        ...
        if (index >= 0) {
          ...
          // var cityValue = { "EQ_parent.id": viewModel.ShopList.getRowByRowId(rowId).getValue('provinceId') };
          ...
          // var countyValue = { "EQ_parent.id": viewModel.ShopList.getRowByRowId(rowId).getValue('cityId') };
          ...
          // var townValue = { "EQ_parent.id": viewModel.ShopList.getRowByRowId(rowId).getValue('countyId') };
          ...
          $._ajax({
            ...
            contentType: "application/json; charset=utf-8",
            success: function (data) {
              viewModel.ShopClerkList.setSimpleData(data, { unSelect: true });
            }
          });
          //根据id查仓库表
          $._ajax({
            ...
            contentType: "application/json; charset=utf-8",
            success: function (data) {
              viewModel.ShopWarehouseList.setSimpleData(data, { unSelect: true });
            }
          });
        } else if (index === -2) {
          //复制操作
          ...
          currentRow.setSimpleData({ "sourceCode": "01" })
      ...
      validate: function (element) {
        var result = viewModel.app.compsValidateMultiParam({ element: element, showMsg: true });
        return result;
      },
      //联系人保存
  ...
  //          viewModel.showDefaultPage();
      ...
      search: function (reindex) {
        ...
        if(customer && customer.id) {
          queryData["search_EQ_customer.id"] = customer.id;
        }
      ...
      savePic: function () {
        ...
        $._ajax({
          ...
          success: function (data) {
            toastr.success("保存成功");
            fileDialog.hide();
            viewModel.shopCredPicList.addSimpleData(data, "nrm", { "unSelect": true });
          }
        })
      ...
      cancelMarket: function () {
        viewModel.MarketAreaList.removeAllRows();
        viewModel.MarketAreaList.setSimpleData(viewModel.marketdata, { "unSelect": true });
        viewModel.currentFlag = 1;
      },
