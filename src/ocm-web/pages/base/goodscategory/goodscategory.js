...
define([
    ...
    var view = baseview.extend({
        ...
        model: model,
        baseData: {
            baseurl: '/goods-categorys',
            statusField: 'isEnable',
            excelurl:'/goods-categorys-excel',
            dialogWidth: '900px',
            ...
            treeSetting: {
                ...
                callback: {
                    beforeClick: function (treeId, treeData) {
                        var refComp = $("#refContainergoodsCategoryKey").data("uui.refer");
                        if(refComp && treeData) {
            ...
            displayInPortalFmt: ko.pureComputed(function () {
                var status = viewModel.simpleList.ref("displayInPortal")();
                var statusName
                if (status == 0) {
                    statusName = "否"
                }
        ...
        events: {
                ...
                if (result.passed) {
                    ...
                    $._ajax({
                        ...
                        success: function (data) {
                            ...
                            var queryData =  {};
                            viewModel.searchTree(queryData);
                        }
                    })
            ...
            search: function (reindex) {
                ...
                $._ajax({
                    ...
                    data: queryData,
                    success: function (data) {
                        /* if(queryData.search_LIKE_parentId ==undefined) {    
                            viewModel.searchTree(queryData);
                        } */
            ...
            clickTree: function () {
                ...
                viewModel.searchcomp.viewModel.params.setValue("parentId", treeData.id);
                viewModel.search(1);
