    ...
    return {
      ...
      beforebatchoperate: function(opr) {
        ...
        if (rows && rows.length > 0) {
          ...
          // 	var tempdata = rows[i].getValue("saleOrderItems").getSimpleData();
          // 	if(tempdata&&tempdata.length>0){
          // 		totalData.push.apply(totalData,tempdata);
          // 	}
          // }
          // if(totalData.length>0){
          // 	viewModel.batchSaleOrderItems.setSimpleData(totalData,{unSelect:true});
          // }
      ...
      saveBill: function() {
        ...
        if (result) {
          ...
          viewModel.saleOrderItems.getAllRows().every(function(row, index) {
            if (!row.getValue('money') || !row.getValue('remainMoney')) {
          ...
          salesorderData.gatherDetails = saleOrderItemsData;
