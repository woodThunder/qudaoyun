define(['text!./feedback.html', 'ocm_common', 'searchbox', 'editcard', 'ocm_repairtrack','text!./data.json',
 './meta.js', 'ocm_global'], function (tpl, common, searchbox, editcard, repairTrack,jsonData) {
  ...
  baseData = {
    ...
    billStatusSrc: [],
    //服务类型枚举
    serviceTypeEnum:[{name:'维修',value:'0'},{name:'送装',value:'1'},{name:'施工',value:'2'}],
    // 服务商枚举
	  serviceProviderEnum:[{name:'保定万隆服务商',value:'0112'},{name:'石家庄怀特经销商',value:'2221'},{name:'保定万隆服务商',value:'33342'},{name:'上海佳宁路维修服务商',value:'333542'}]
    ...
    singledocSearch = new searchbox(
      $("#PromoActivity-searchcontent")[0], [{
        ...
        },
        {
          ...
          key: "serviceType",
          label: "服务类型",
          dataSource: viewModel.serviceTypeEnum
        },
        {
          type: "combo",
          key: "serviceProviderName",
          label: "服务商",
          dataSource: viewModel.serviceProviderEnum
        },
        {
          type: "text",
          key: "customerName",
