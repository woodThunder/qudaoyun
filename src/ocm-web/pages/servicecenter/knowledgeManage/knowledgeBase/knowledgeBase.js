define(['text!./knowledgeBase.html', 'ocm_common', 'searchbox', 'editcard', 'ocm_repairtrack','text!./data.json',
 './meta.js', 'ocm_global'], function (tpl, common, searchbox, editcard, repairTrack,jsonData) {
  ...
  baseData = {
    ...
    billStatusSrc: [],
    //类型枚举
    knowledgeTypeEnum:[{name:'维修类',value:'0'},{name:'安装类',value:'1'},{name:'保养类',value:'2'}]
    ...
    singledocSearch = new searchbox(
      $("#PromoActivity-searchcontent")[0], [{
        ...
        },
        {
          ...
          key: "knowledgeType",
          label: "知识类型",
          dataSource: viewModel.knowledgeTypeEnum
        },
        {
          type: "text",
          key: "titleName",
