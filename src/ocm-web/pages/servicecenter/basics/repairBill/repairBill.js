define(['text!./repairBill.html', 'ocm_common', 'searchbox', 'editcard', 'ocm_repairtrack', './meta.js', 'ocm_global'], function (tpl, common, searchbox, editcard, repairTrack) {
  'use strict'
  ...
  events = {
    ...
    detail: function (index, rowId) {
      ...
      // 跟踪记录
      var   processData = viewModel.processList.getSimpleData();
    ...
    fillOrderDetailData: function (id) {
      $._ajax({
        ...
        success: function (data) {
          ...
          viewModel.processList.setSimpleData(data.processes);
        }
      })
    },
