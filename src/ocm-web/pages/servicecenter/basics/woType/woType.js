define(['text!./woType.html', 'ocm_common', 'searchbox', 'editcard', './meta.js', 'ocm_global'], function(tpl, common, searchbox, editcard) {
	'use strict'
	var app, baseData, events, rendertype, viewModel, singledocSearch,popupDialog,popupMainDataListData,radio;
	baseData = {
		baseurl: '/sc/wo-types',
		...
		radiodata:[{value:'1',name:'启用'},{value:'0',name:'停用'}],
	...
	events = {
		...
		//启用
		batchEnable:function(index,rowId){
		...
		//停用
		batchDisable:function(index,rowId){
			if (typeof (rowId) == 'number') {
				viewModel.mainDataList.setRowSelectbyRowId(rowId);
			  }
			  var ids = [];
