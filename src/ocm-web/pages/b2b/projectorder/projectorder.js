...
define([
    ...
    var view = baseview.extend({
        ...
        baseData: {
            ...
            saleOrderItems: {
                templateType: "card",
                cls: "project_OrderItem"
            }, //订单行

            saleOrderItemsProms: {
                templateType: "card",
                cls: "project_OrderPromRel"
            }, //订单行
            batchSaleOrderBomItems: {
                templateType: "card",
                cls: "project_OrderItemBom"
            },
            // 待关闭订单条目
            ...
            referContractList: new u.DataTable(model.options.metas.contractMeta),
            referSelectContractList: new u.DataTable(model.options.metas.contractMeta),
            gridContractList: model.options.grids.gridContractList,
            gridContractSelect: model.options.grids.gridContractSelect,
            pageContractAdd: ko.observableArray([]),
            pageContractModel: {
            ...
            contractSearchcomp: {},
            contractSearchSource: model.options.searchs.contractSearch,
            listRenderTypes: {
