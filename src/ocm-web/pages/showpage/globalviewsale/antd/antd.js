...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	([
			...
			var CalendarHeader = (0, _createReactClass2['default'])({
				...
				componentWillReceiveProps: function componentWillReceiveProps() {
					...
					if ('showMonthpanel' in props) {
						this.setState({
							showMonthPanel: props.showMonthPanel
						});
					}
					if ('showYearpanel' in props) {
						this.setState({
							showYearPanel: props.showYearPanel
						});
					}
				},
				...
				triggerPanelChange: function triggerPanelChange(panelStatus) {
					if (!('showMonthPanel' in this.props)) {
						this.setState({
							showMonthPanel: panelStatus.showMonthPanel
						});
					}
					if (!('showYearPanel' in this.props)) {
						this.setState({
							showYearPanel: panelStatus.showYearPanel
						});
					}
				...
				function RangePicker(props) {
					...
					_this.handleChange = function(value) {
						...
						if (!('value' in props)) {
							_this.setState({
								value: value,
								showDate: getShowDateFromValue(value)
							});
						}
				...
				(0, _createClass3['default'])(RangePicker, [{
					...
					value: function render() {
						...
						var calendar = _react2['default'].createElement(_RangeCalendar2['default'], (0, _extends3['default'])({}, calendarHandler, {
							...
							locale: locale.lang,
							onOk: onOk,
							value: showDate || pickerValueAdapter(props.defaultPickerValue) || pickerValueAdapter((0, _moment2['default'])()),
						...
						return _react2['default'].createElement(
							'span', {
								...
								style: (0, _objectAssign2['default'])({}, style, pickerStyle)
							},
							_react2['default'].createElement(
								_Picker2['default'],
				...
				return _a = function(_React$Component) {
					...
					(0, _createClass3['default'])(CalenderWrapper, [{
						...
						value: function render() {
							...
							var calendar = _react2['default'].createElement(TheCalendar, (0, _extends3['default'])({}, calendarHandler, {
								disabledDate: props.disabledDate,
								disabledTime: disabledTime,
								locale: locale.lang,
								timePicker: props.timePicker,
								defaultValue: props.defaultPickerValue || (0, _moment2['default'])(),
							...
							return _react2['default'].createElement(
								'span', {
									className: props.pickerClass,
									style: (0, _objectAssign2['default'])({}, props.style, pickerStyle)
								},
								_react2['default'].createElement(
									_Picker2['default'],
									(0, _extends3['default'])({}, props, pickerChangeHandler, {
		...
		(function(module, exports, __webpack_require__) {
			...
			module.exports = {
				"default": __webpack_require__(182),
				__esModule: true
			};
		...
		(function(module, exports, __webpack_require__) {
			...
			module.exports = {
				"default": __webpack_require__(185),
				__esModule: true
			};
		...
		(function(module, exports, __webpack_require__) {
			...
			__webpack_require__(38)(IteratorPrototype, __webpack_require__(19)('iterator'), function() {
				return this;
			});
		...
		(function(module, exports, __webpack_require__) {
			...
			function domAlign(el, refNode, align) {
				...
				if (target.ownerDocument.body.contains(target)) { //解决表格里的时间控件点选日期时回到左上角的问题
					var refNodeRegion = (0, _getRegion2['default'])(target);
				} else {
					var refNodeRegion = {
						left: parseInt(source.style.left),
						top: parseInt(source.style.top)
					};
				}
		...
		(function(module, exports, __webpack_require__) {
			...
			u.DateTimeAdapter.prototype.createUIComp = function(obj) {
				...
				if (this.options.rangeFlag) {
					...
					;
					if (this.adapterType == 'datetime') {
						comp = ReactDOM.render(React.createElement(DatePicker, {
							showTime: {
