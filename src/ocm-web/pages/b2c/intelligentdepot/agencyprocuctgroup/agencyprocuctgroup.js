define(['text!./agencyprocuctgroup.html', 'ocm_common', 'ocm_baseview', './meta.js'], function(tpl, common, baseview, model) {
  'use strict'
  ...
  var view = baseview.extend({
    ...
    model: model,
    baseData: {
      baseurl: '/route/customer-packages',
    ...
    afterCreate: function() {
      ...
      viewModel.depotProductList.on("brandId.valuechange", function(obj) {
        ...
        // viewModel.depotProductList.setValue('brandName', refValues[0].refname);
      });
      // 商品分类增行
