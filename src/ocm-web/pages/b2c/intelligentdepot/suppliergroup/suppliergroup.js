define(['text!./suppliergroup.html', 'ocm_common', 'ocm_baseview', './meta.js'], function(tpl, common, baseview, model) {
  'use strict'
  ...
  var view = baseview.extend({
    ...
    model: model,
    baseData: {
      baseurl: '/route/supplier-packages',
      depotProductList: new u.DataTable(model.options.metas.supplyproduct),
      productCateItem: new u.DataTable(model.options.metas.supplycateItem),
