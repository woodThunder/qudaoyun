define(['text!./suningrefund.html', 'ocm_common', 'searchbox', './meta.js', 'ocm_global'], function (tpl, common, searchbox) {
  'use strict'
  var app, baseData, events, rendertype, viewModel, singledocSearch;
  baseData = {
    baseurl: '/dc/suning-refunds',
    ...
    auditStatusSrc:[
      ...
      { value: "1", name: "审核通过" },
      { value: "2", name: "审核不通过" },
      { value: "3", name: "苏宁财务审核通过" },
      { value: "4", name: "苏宁财务审核不通过" },
      { value: "5", name: "人工审核通过" },
      { value: "6", name: "拦截并退款" },
      { value: "7", name: "青龙拦截成功" },
      { value: "8", name: "青龙拦截失败" },
  ...
  events = {
    ...
    saveBill: function () {
      ...
      var storeData = viewModel.refundList.getCurrentRow().getSimpleData();
