define(["ocm_global"], function () {
    ...
    window.mainDataMeta = {
        ...
        meta: {
            ...
            soBillNo: { type: "string", maxLength: 50 },
            ...
            isCanSell: { type: "integer", required: true, default: "1" },//是否可二次销售
            ...
            clearRate: { type: "float", regExp: /^([01](\.0+)?|0\.[0-9]+)$/, errorMsg: '请输入大于等于0小于等于1的数', required: true },
            clearReason:{type: "string",required: true,maxLength:600 }//清理原因
