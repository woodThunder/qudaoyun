...
KindEditor.lang(
  {
    ...
    cutError:
      "حاليا غير مدعومة من المتصفح, إستخدم إختصار لوحة المفاتيح (Ctrl+X).",
    copyError:
      "حاليا غير مدعومة من المتصفح, إستخدم إختصار لوحة المفاتيح (Ctrl+C).",
    pasteError:
      "حاليا غير مدعومة من المتصفح, إستخدم إختصار لوحة المفاتيح (Ctrl+V).",
    ajaxLoading: "Loading ...",
    uploadLoading: "Uploading ...",
    uploadError: "Upload Error",
    "plainpaste.comment":
      "إستخدم إختصار لوحة المفاتيح (Ctrl+V) للصق داخل النافذة.",
    "wordpaste.comment":
      "إستخدم إختصار لوحة المفاتيح (Ctrl+V) للصق داخل النافذة.",
