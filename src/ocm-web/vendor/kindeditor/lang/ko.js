...
KindEditor.lang(
  {
    ...
    cutError:
      "브라우저가 잘라내기 기능을 지원하지 않습니다, 단축키로 대신 사용하세요. (Ctrl+X)",
    copyError:
      "브라우저가 복사 기능을 지원하지 않습니다, 단축키로 대신 사용하세요. (Ctrl+X)",
    pasteError:
      "브라우저가 붙여넣기 기능을 지원하지 않습니다, 단축키로 대신 사용하세요. (Ctrl+X)",
    ajaxLoading: "불러오는 중 ...",
    uploadLoading: "업로드 중 ...",
    uploadError: "업로드 오류",
    "plainpaste.comment":
      "단축키(Ctrl+V)를 통하여 여기에 텍스트를 붙여넣으세요.",
    "wordpaste.comment":
      "단축키(Ctrl+V)를 통하여 여기에 워드 텍스트를 붙여넣으세요.",
    ...
    "multiimage.uploadDesc":
      "최대 이미지 개수: <%=uploadLimit%>개, 개당 이미지 크기: <%=sizeLimit%>",
