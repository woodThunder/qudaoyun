...
(function(window, undefined) {
  ...
  function _formatHtml(html, htmlTags, urlType, wellFormatted, indentChar) {
    ...
    html = html.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/gi, function(
      $0,
      $1,
      $2,
      $3
  ...
  function _mediaImg(blankPath, attrs) {
    ...
    var html =
      '<img class="' + _mediaClass(type) + '" src="' + blankPath + '" ';
    if (style !== "") {
      html += 'style="' + style + '" ';
    }
  ...
  _extend(KCmd, {
    ...
    insertimage: function(url, title, width, height, border, align) {
      ...
      var html =
        '<img src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
      if (width) {
...
KindEditor.plugin("image", function(K) {
  var self = this,
    ...
    extraParams = K.undef(self.extraFileUploadParams, params),
    filePostName = K.undef(self.filePostName, "imgFile"),
  ...
  self.plugin.imageDialog = function(options) {
    ...
    //todo...
    var pk = K.generateMixed();
    extraParams.filepath = pk;
    extraParams.groupname = pk;
    ...
    var html = [
      ...
      '<input type="text" name="url" class="ke-input-text" tabindex="-1" style="display:none;" /> &nbsp;',
      '<input type="button" class="ke-upload-button" value="' +
        lang.upload +
        '" />',
      "</div>",
    ...
    widthBox.change(function(e) {
      if (originalWidth > 0) {
        heightBox.val(
          Math.round(originalHeight / originalWidth * parseInt(this.value, 10))
        );
      }
    });
    heightBox.change(function(e) {
      if (originalHeight > 0) {
        widthBox.val(
          Math.round(originalWidth / originalHeight * parseInt(this.value, 10))
        );
      }
    });
        ...
        dialog = self.createDialog({
          ...
          yesBtn: {
            ...
            click: function(e) {
              ...
              self
                .exec("createlink", url, typeBox.val())
                .hideDialog()
                .focus();
            }
          }
