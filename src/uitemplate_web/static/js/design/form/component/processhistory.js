define("form/component/processhistory", ["form/component", "form/tplutil"], function() {
	var m = require("form/component");
	var l = require("form/tplutil");
	
	window.ProcessHistory = m.extend({
		initialize: function(a) {
			this.componentSetup = {
				componentKey: "ProcessHistory",
				title: "审批历史",
				...
				size: "large",  //控件尺寸 
				historyOrder: "positive_sequence",  //审批历史显示顺序
				isShowRelateAttr: !1,//是否显示相关属性
				approveUserDept:!1,//相关属性-审批人部门
				approveUserPost:!1,//相关属性-审批人岗位
				approveUserJob:!1,//相关属性-审批人职务
				isReadonly: !1,
				borderColor:"",//边框颜色
				islist:true //是否列表显示
			};
			null != a && (this.componentSetup.title = a.title, 
					...
					this.componentSetup.approveUserDept = a.approveUserDept, 
					this.componentSetup.approveUserPost = a.approveUserPost, 
					this.componentSetup.approveUserJob = a.approveUserJob, 
					this.componentSetup.historyOrder = a.historyOrder, 
		...
		setBillMakerDept: function(a) {
			this.componentSetup.approveUserDept = a
		},
		setBillMakerPost: function(a) {
			this.componentSetup.approveUserPost = a
		},
		setHistoryOrder: function(a) {
			this.componentSetup.historyOrder = a
		},
		setBillMakerJob: function(a) {
			this.componentSetup.approveUserJob = a
		},
		...
		render: function(a) {
			var b = $(this.tpl).siblings("#form-processhistory");
		...
		renderEditor: function() {
			var a = $(this.tpl).siblings("#editor-processhistory");
			...
			a.find("input:radio[name='tOrder'][value='" + this.componentSetup.historyOrder + "']").attr("checked", "true");
			...
			"true" != this.componentSetup.approveUserDept && 1 != this.componentSetup.approveUserDept || a.find("#billmaker_department").attr("checked", "true");
			"true" != this.componentSetup.approveUserPost && 1 != this.componentSetup.approveUserPost || a.find("#billmaker_post").attr("checked", "true");
			"true" != this.componentSetup.approveUserJob && 1 != this.componentSetup.approveUserJob || a.find("#billmaker_job").attr("checked", "true");
