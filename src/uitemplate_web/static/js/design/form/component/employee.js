define("form/component/employee", ["form/component", "form/tplutil", "form/component/userselecter"], function() {
	...
	window.Employee = m.extend({
		initialize: function(a) {
			...
			null != a && (this.componentSetup.title = a.title, 
					...
					this.componentSetup.isUnique = a.isUnique, 
					this.componentSetup.borderColor = a.borderColor,
					this.componentSetup.isCurrentEmployee = a.isCurrentEmployee, 
					this.componentSetup.borderColor = a.borderColor,
