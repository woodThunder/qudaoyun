define("form/component/approveopinion", ["form/component", "form/tplutil", "form/component/userselecter"], function() {
	var m = require("form/component");
	var l = require("form/tplutil"),
		b = require("form/component/userselecter");
	
	window.ApproveOpinion = m.extend({
		initialize: function(a) {
			this.componentSetup = {
				componentKey: "ApproveOpinion",
				title: "审批意见",
		...
		render: function(a) {
			var b = $(this.tpl).siblings("#form-approveopinion");
		...
		renderEditor: function() {
			var a = $(this.tpl).siblings("#editor-approveopinion");
			...
			this.getAllActivitis(a,this.componentSetup.processActivity);
		},
		...
		renderStatSearch: function(a) {
			var b = this,
				d = $(this.tpl).siblings("#statsearch-approveopinion"),
				e = a.parentEl;
			a = a.container;
