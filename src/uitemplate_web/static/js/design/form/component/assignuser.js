define("form/component/assignuser", ["form/component", "form/tplutil", "form/component/userselecter"], function() {
	var m = require("form/component");
	var l = require("form/tplutil"),
		b = require("form/component/userselecter");
	
	window.AssignUser = m.extend({
		initialize: function(a) {
			this.componentSetup = {
				componentKey: "AssignUser",
				title: "指派人",
			...
			null != a && (this.componentSetup.title = a.title, 
					...
					this.componentSetup.assignUsers = a.assignUsers, 
		...
		setAssignUsers: function(a) {
			this.componentSetup.assignUsers = a
		},
		...
		render: function(a) {
			var b = $(this.tpl).siblings("#form-assignuser");
		...
		renderEditor: function(f) {
			var a = $(this.tpl).siblings("#editor-assignuser");
...
//			"true" != this.componentSetup.required && 1 != this.componentSetup.required || a.find("#required").attr("checked", "true");
		...
		renderStatSearch: function(a) {
			var b = this,
				d = $(this.tpl).siblings("#statsearch-assignuser"),
				e = a.parentEl;
			a = a.container;
